...
class BahanKimiaExport implements WithMultipleSheets
{
    protected $request;
    ...
    {
        return [
            'Data' => new BahanKimiaDataSheet($this->request),
            'Eviden' => new BahanKimiaEvidenSheet($this->request)
        ];
    }
}

class BahanKimiaDataSheet implements FromView
{
    protected $request;
...
class BahanKimiaEvidenSheet implements FromView
{
    protected $request;
    ...
    public function view(): View
    {
        ...
        return view('admin.energiprimer.exports.bahan-kimia-eviden-excel', [
            'bahanKimia' => $bahanKimia,
            'units' => $units,
            'navlog_path' => public_path('logo/navlog1.png'),
            'k3_path' => public_path('logo/k3_logo.png')
