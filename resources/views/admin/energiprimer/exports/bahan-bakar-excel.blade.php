    ...
    <table>
        <thead>
            ...
            <tr>
                ...
                <th style="font-weight: bold; background-color: #f2f2f2; width: 150px;">Jenis BBM</th>
...
<div class="sheet">
    <table>
        ...
        <tbody>
            @foreach($bahanBakar->sortBy('tanggal') as $item)
                @if($item->evidence)
                <tr>
                    <td>{{ $item->tanggal->format('Y-m-d') }}</td>
                    <td>{{ $item->unit->name }}</td>
