...
<div class="flex h-screen bg-gray-100">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="flex items-center pt-2">
            <x-admin-breadcrumb :breadcrumbs="[['name' => 'Operasi UPKD', 'url' => null], ['name' => 'Rapat & Link Koordinasi RON', 'url' => null]]" />
        </div>
            ...
            <div class="container mx-auto px-4 sm:px-6">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-sm p-6 mb-6 text-white relative">
                    <div class="max-w-3xl">
                        ...
                        <p class="text-blue-100 mb-4">Kelola dan monitor rapat serta koordinasi RON untuk memastikan komunikasi yang efektif antar tim.</p>
