        ...
        <main class="px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transform transition-all duration-300 hover:shadow-xl">
                        <div class="p-6">
                            ...
                            <div class="grid grid-cols-7 bg-gradient-to-r from-[#009BB9] to-[#0A749B] rounded-t-lg">
                                ...
                                <div class="text-center py-3 text-sm font-semibold text-white">Rabu</div>
                                <div class="text-center py-3 text-sm font-semibold text-white">Kamis</div>
                                <div class="text-center py-3 text-sm font-semibold text-white">Jumat</div>
                                <div class="text-center py-3 text-sm font-semibold text-white">Sabtu</div>
                            </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden transform transition-all duration-300 hover:shadow-xl">
                        <div class="p-6">
                            <h2 class="text-lg font-semibold text-gray-800 mb-4">Semua Jadwal</h2>
                                                ...
                                                <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:border-[#009BB9] transition-all duration-300 transform hover:-translate-y-1 hover:shadow-md">
                                                    ...
                                                    <div class="mt-3 pt-3 border-t border-gray-100 flex justify-end space-x-2">
                                                        ...
                                                        <form action="{{ route('admin.kalender.destroy', $schedule['id']) }}" 
                                                            ...
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="text-red-600 hover:text-red-800 p-2 hover:bg-red-50 rounded-lg transition-all duration-300">
...
/* Add smooth hover transition for calendar cells */
