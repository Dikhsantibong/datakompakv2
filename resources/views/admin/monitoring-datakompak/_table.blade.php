                                        ...
                                        <div class="hidden group-hover:block absolute z-20 bg-white border rounded-lg shadow-lg p-4 min-w-[300px] text-left -translate-x-1/2 left-1/2 mt-2">
                                            <div class="text-sm">
                                                ...
                                                <div class="grid grid-cols-2 gap-2">
                                                    ...
                                                    <p>{{ $dayData['data']->operator }}</p>
                                                    <p class="text-gray-600">Shift:</p>
                                                    <p>{{ $dayData['data']->shift }}</p>
                                                    <p class="text-gray-600">Mesin:</p>
                                                    <p>{{ $dayData['data']->mesin }}</p>
                                                    <p class="text-gray-600">Status:</p>
                                                    <p>{{ $dayData['data']->status }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                        ...
                                        <div class="hidden group-hover:block absolute z-20 bg-white border rounded-lg shadow-lg p-4 min-w-[300px] text-left -translate-x-1/2 left-1/2 mt-2">
                                            <div class="text-sm">
                                                ...
                                                <div class="grid grid-cols-2 gap-2">
                                                    ...
                                                    <p>{{ $dayData['data']->created_by }}</p>
                                                    <p class="text-gray-600">Total Pemeriksaan:</p>
                                                    <p>{{ $dayData['data']->pemeriksaan->count() }}</p>
                                                    <p class="text-gray-600">Total Program Kerja:</p>
                                                    <p>{{ $dayData['data']->programKerja->count() }}</p>
                                                </div>
                                            </div>
                                        </div>
                                    @else
                                        ...
                                        <div class="hidden group-hover:block absolute z-20 bg-white border rounded-lg shadow-lg p-4 min-w-[300px] text-left -translate-x-1/2 left-1/2 mt-2">
                                            <div class="text-sm">
                                                ...
                                                <div class="grid grid-cols-2 gap-2">
                                                    ...
                                                    <p>{{ $dayData['data']->time }}</p>
                                                    <p class="text-gray-600">Status:</p>
                                                    <p>{{ $dayData['data']->status }}</p>
                                                </div>
                                                @if($dayData['data']->notes)
                                                    <div class="mt-2 pt-2 border-t">
                                                        <p class="text-gray-600">Notes:</p>
                                                        <p class="mt-1">{{ $dayData['data']->notes }}</p>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
