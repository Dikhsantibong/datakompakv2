<table>
    ...
    <tr>
        ...
        <td colspan="2">{{ $equipment->keterangan ?? '-' }}</td>
    </tr>
    @endforeach
    <tr><td colspan="5"></td></tr>
    ...
    <tr>
        ...
        <td colspan="3">{{ $meetingShift->systemNote->content ?? '-' }}</td>
    </tr>
    <tr>
        <td colspan="2">Catatan Umum</td>
        <td colspan="3">{{ $meetingShift->generalNote->content ?? '-' }}</td>
    </tr>
    <tr>
        <td colspan="2">Resume</td>
        <td colspan="3">{{ $meetingShift->resume->content ?? '-' }}</td>
    </tr>
    <tr><td colspan="5"></td></tr>
    ...
    <tr><td colspan="5"></td></tr>
    <tr class="footer">
        <td colspan="5">Dibuat oleh: {{ $meetingShift->creator->name }} | Tanggal: {{ $meetingShift->created_at->format('d/m/Y H:i') }}</td>
    </tr>
</table> 