        ...
        <div class="py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="bg-white rounded-lg shadow-md">
                    <div class="p-6">
                        <form action="{{ route('admin.energiprimer.bahan-kimia.update', $bahanKimia->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea name="catatan_transaksi" rows="3"
                                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                              placeholder="Masukkan catatan transaksi...">{{ $bahanKimia->catatan_transaksi }}</textarea>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    @if($bahanKimia->evidence)
                                        <div class="mt-2 flex items-center space-x-2">
                                            ...
                                            <a href="{{ Storage::url($bahanKimia->evidence) }}" 
                                               target="_blank"
