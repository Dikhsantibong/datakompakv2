        ...
        <div id="main-content" class="flex-1 main-content">
            ...
            <header class="bg-white shadow-sm sticky top-0 z-10">
                <div class="flex justify-between items-center px-6 py-3">
                    <div class="flex items-center gap-x-3">
                        ...
                        <h1 class="text-xl font-semibold text-gray-800">Dokumen Operasi Lainnya</h1>
                    </div>
            ...
            <div class="flex items-center pt-2">
                <x-admin-breadcrumb :breadcrumbs="[
                    ...
                    ['name' => 'Dokumen Operasi Lainnya', 'url' => null]
                ]" />
            </div>
            ...
            <main class="px-6 py-6">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h2 class="text-lg font-semibold">Daftar Dokumen Operasi Lainnya</h2>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($operasiLainnyaFiles ?? [] as $file)
                                <tr>
