...
<div class="flex h-screen bg-gray-100">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white shadow-sm">
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                <div class="flex items-center">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900">Data Bahan Bakar</h1>
                </div>
        ...
        <div class="flex items-center pt-2">
            <x-admin-breadcrumb :breadcrumbs="[['name' => 'Data Bahan Bakar', 'url' => null]]" />
        </div>
                                    ...
                                    @if(request()->has('unit_id') || request()->has('jenis_bbm') || request()->has('start_date') || request()->has('end_date'))
                                        <div class="flex flex-wrap gap-2" id="active-filters">
                                            ...
                                            @if(request('jenis_bbm'))
                                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                    BBM: {{ request('jenis_bbm') }}
                                                    <button onclick="removeFilter('jenis_bbm')" class="ml-1 text-blue-600 hover:text-blue-800">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </span>
                                            @endif
